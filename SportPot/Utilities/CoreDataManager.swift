...
class CoreDataManager {
    ...
    lazy var fetchedResultsController: NSFetchedResultsController<FixtureMO> = {
         ...
         */
        let fetchRequest = NSFetchRequest<FixtureMO>(entityName: "Fixture")
        ...
        let fetchedResultsController = NSFetchedResultsController<FixtureMO>(fetchRequest: fetchRequest, managedObjectContext: managedContext, sectionNameKeyPath: nil, cacheName: nil)
    ...
    func insertFixture(response: Array<FixtureMO>) -> FixtureMO? {
